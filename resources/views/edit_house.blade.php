            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5" style="margin-left: 35em; margin-right: auto; width: 50%; font-size: 13pt">
                ...
                <form method="POST" action="/house/{{ $house->id }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="house_name" class="bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white">
